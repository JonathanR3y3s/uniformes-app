...
export function saveDotaciones(){save('_dotaciones',store.dotaciones);_push('dotaciones',store.dotaciones);}
export function getDotaciones(){return store.dotaciones||[];}
export function saveDotacionTipos(){save('_dotacion_tipos',store.dotacionTipos);_push('dotacionTipos',store.dotacionTipos);}
