import{REGLAS,VERSION}from'./config.js';import{init as initStorage}from'./storage.js';import{buildNav,setupEvents,destroyCharts}from'./ui.js';
...
(function(){initStorage(REGLAS);const v=location.hash.slice(1)||'dashboard';currentView=views[v]?v:'dashboard';buildNav(currentView);setupEvents(navigate);render();console.log('[ASSA ABLOY] Sistema de Uniformes v'+VERSION+' — Listo.');})();
