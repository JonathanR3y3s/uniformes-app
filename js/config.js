...
{id:'operador',icon:'fa-shipping-fast',label:'Entrega por Operador'},
{id:'totales',icon:'fa-calculator',label:'Totales'},
{id:'tablero',icon:'fa-th-large',label:'Tablero Maestro'},
{section:'REPORTES'},
{id:'admin',icon:'fa-tachometer-alt',label:'Admin Dashboard'},
{id:'reportes',icon:'fa-chart-line',label:'Reportes Avanzados'},
{section:'GESTIÓN'},
