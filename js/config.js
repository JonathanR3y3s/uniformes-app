...
{id:'admin-dashboard',icon:'fa-shield-halved',label:'Panel Admin'},
{id:'usuarios',icon:'fa-users-gear',label:'Usuarios'},
{id:'areas',icon:'fa-sitemap',label:'Áreas'},
{id:'campanias',icon:'fa-bullhorn',label:'Campañas'},
{id:'stock-uniformes',icon:'fa-warehouse',label:'Stock Uniformes'},
